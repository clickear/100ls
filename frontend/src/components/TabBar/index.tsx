...
const tabs: { id: TabId; label: string; icon: React.ReactNode }[] = [
  { id: 'subtitles', label: '首页', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M3 9.5L12 3L21 9.5V19C21 20.1 20.1 21 19 21H15V14H9V21H5C3.9 21 3 20.1 3 19V9.5Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg> },
